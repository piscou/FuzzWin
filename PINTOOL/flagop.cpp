#include "flagop.h"
#include "buildFormula.h" // pour SALC
...
void FLAGOP::cCLC_STC(INS &ins)
{
    ...
    INS_InsertCall(ins, IPOINT_ANYWHERE, (AFUNPTR) sCLC_STC,
...
void FLAGOP::cCMC(INS &ins)
{
    ...
    INS_InsertCall(ins, IPOINT_ANYWHERE, (AFUNPTR) sCMC,
        IARG_FAST_ANALYSIS_CALL,
        IARG_THREAD_ID,
        CALLBACK_DEBUG IARG_END);
} // cCMC
...
void FLAGOP::cLAHF(INS &ins)
{
    ...
    INS_InsertCall(ins, IPOINT_ANYWHERE, (AFUNPTR) sLAHF,
        IARG_THREAD_ID,
...
void FLAGOP::cSAHF(INS &ins)
{
    ...
    INS_InsertCall(ins, IPOINT_ANYWHERE, (AFUNPTR) sSAHF,
        IARG_THREAD_ID,
        CALLBACK_DEBUG IARG_END);
} // cSAHF
