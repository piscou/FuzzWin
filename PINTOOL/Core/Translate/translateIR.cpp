...
std::string TranslateIR::getDeBruijnArray()
{
...
std::string TranslateIR::setObjectName(const TaintPtr &tPtr)
{
...
std::string TranslateIR::getSourceName(const ObjectSource &objSrc) const
{
...
void TranslateIR::declareRelationHeader(const TaintPtr &tPtr)
{
	// affectation d'un nom de variable SMTLIB à l'objet
...
void TranslateIR::declareRelationFooter(const TaintPtr &tPtr)
{
	_formula << "));";
	if (g_verbose)
	{
...
void TranslateIR::translate_BYTESOURCE(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_EXTRACT(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_CONCAT(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_ASSIGN(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_SIGNEXTEND(const TaintPtr &tPtr)
{
	UINT32 lengthOfResult = tPtr->getLength();
...
void TranslateIR::translate_X_ZEROEXTEND(const TaintPtr &tPtr)
{
	UINT32 lengthOfResult = tPtr->getLength();
	ObjectSource source = tPtr->getSource(0); // forcément marquée
	UINT32 lengthOfSource = source.getLength();
...
void TranslateIR::translate_X_ADD(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_INC(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_SUB(const TaintPtr &tPtr)
{
	ObjectSource src0 = tPtr->getSource(0);
	ObjectSource src1 = tPtr->getSource(1);
...
void TranslateIR::translate_X_DEC(const TaintPtr &tPtr)
{
	// source 0 forcément marquée
...
void TranslateIR::translate_X_NEG(const TaintPtr &tPtr)
{
	// source 0 forcément marquée
...
// NON IMPLEMENTE : MUL
void TranslateIR::translate_X_MUL(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_IMUL(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_DIV_QUO(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_DIV_REM(const TaintPtr &tPtr)
{
	UINT32 lengthOfQuotient = tPtr->getLength();
	ObjectSource objHighDividend = tPtr->getSource(0);
	ObjectSource objLowDividend = tPtr->getSource(1);
...
void TranslateIR::translate_X_IDIV_QUO(const TaintPtr &tPtr)
{
	UINT32 lengthOfQuotient = tPtr->getLength();
	ObjectSource objHighDividend = tPtr->getSource(0);
	ObjectSource objLowDividend = tPtr->getSource(1);
...
void TranslateIR::translate_X_IDIV_REM(const TaintPtr &tPtr)
{
	UINT32 lengthOfQuotient = tPtr->getLength();
	ObjectSource objHighDividend = tPtr->getSource(0);
	ObjectSource objLowDividend = tPtr->getSource(1);
...
void TranslateIR::translate_X_AND(const TaintPtr &tPtr)
{
	ObjectSource src0 = tPtr->getSource(0);
	ObjectSource src1 = tPtr->getSource(1);
...
void TranslateIR::translate_X_OR(const TaintPtr &tPtr)
{
	ObjectSource src0 = tPtr->getSource(0);
	ObjectSource src1 = tPtr->getSource(1);
...
void TranslateIR::translate_X_XOR(const TaintPtr &tPtr)
{
	ObjectSource src0 = tPtr->getSource(0);
	ObjectSource src1 = tPtr->getSource(1);
...
void TranslateIR::translate_X_NOT(const TaintPtr &tPtr)
{
	BEGIN_RELATION_DECLARATION;
...
void TranslateIR::translate_X_SHL(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_SHR(const TaintPtr &tPtr)
{
	// récupération des sources : opérande déplacée (marqué ou non) et valeur du déplacement (marqué ou non)
	ObjectSource shiftedSrc = tPtr->getSource(0);
	ObjectSource displSrc = tPtr->getSource(1);
...
void TranslateIR::translate_X_SAR(const TaintPtr &tPtr)
{
	// récupération des sources : opérande déplacée (marqué ou non) et valeur du déplacement (marqué ou non)
	ObjectSource shiftedSrc = tPtr->getSource(0);
	ObjectSource displSrc = tPtr->getSource(1);
...
void TranslateIR::translate_X_ROR(const TaintPtr &tPtr)
{
	// récupération des sources : opérande déplacée (marqué ou non) et valeur du déplacement (marqué ou non)
	ObjectSource shiftedSrc = tPtr->getSource(0);
	ObjectSource displSrc = tPtr->getSource(1);
...
void TranslateIR::translate_X_ROL(const TaintPtr &tPtr)
{
	// récupération des sources : opérande déplacée (marqué ou non) et valeur du déplacement (marqué ou non)
	ObjectSource shiftedSrc = tPtr->getSource(0);
	ObjectSource displSrc = tPtr->getSource(1);
...
void TranslateIR::translate_X_RCR(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_RCL(const TaintPtr &tPtr)
{
	// récupération des sources : opérande déplacée (marqué ou non) , valeur du CF (marqué ou non) 
	// et valeur du déplacement (marqué ou non)
	ObjectSource shiftedSrc = tPtr->getSource(0);
...
void TranslateIR::translate_X_SETCC(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_COMPLEMENT_BIT(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_SET_BIT(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_CLEAR_BIT(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_BSF(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_BSR(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_AAA_AL(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_AAA_AH(const TaintPtr &tPtr)
{
	// condition de AAA : "IF (((AL and 0FH) > 9) or (AF=1)"
...
void TranslateIR::translate_X_AAD(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_AAM_AL(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_AAM_AH(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_AAS_AL(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_AAS_AH(const TaintPtr &tPtr)
{
	// condition de AAS : "IF (((AL and 0FH) > 9) or (AF=1)" (idem AAA)
...
void TranslateIR::translate_X_DAA_1ST(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_DAA_2ND(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_DAS_1ST(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_DAS_2ND(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_X_SALC(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_F_LSB(const TaintPtr &tPtr)
{
	BEGIN_RELATION_DECLARATION;
...
void TranslateIR::translate_F_MSB(const TaintPtr &tPtr)
{
	ObjectSource src0 = tPtr->getSource(0);
...
void TranslateIR::translate_F_CARRY_ADD(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_F_CARRY_SUB(const TaintPtr &tPtr)
{
	ObjectSource src0 = tPtr->getSource(0);
	ObjectSource src1 = tPtr->getSource(1);
...
void TranslateIR::translate_F_CARRY_NEG(const TaintPtr &tPtr)
{
	ObjectSource src0 = tPtr->getSource(0);
...
void TranslateIR::translate_F_CARRY_MUL(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_F_CARRY_IMUL(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_F_CARRY_SHL(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_F_CARRY_SHR(const TaintPtr &tPtr) // SAR = idem
{
...
void TranslateIR::translate_F_CARRY_RCL(const TaintPtr &tPtr)
{
	// dernier bit ejecté vers la gauche = bit (lengthInBits - count) de la source
	// récupération par LSB (src >> (lengthInBits - count))
	// ici count est marqué, sinon la fonction d'analyse aurait traité directement
...
void TranslateIR::translate_F_CARRY_RCR(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_F_CARRY_BITBYTE(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_F_PARITY(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_F_IS_NULL(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_F_ARE_EQUAL(const TaintPtr &tPtr)
{
	ObjectSource src0 = tPtr->getSource(0);
	ObjectSource src1 = tPtr->getSource(1);
...
void TranslateIR::translate_F_CMPXCHG_8B16B(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_F_OVERFLOW_ADD(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_F_OVERFLOW_SUB(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_F_OVERFLOW_INC(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_F_OVERFLOW_DEC(const TaintPtr &tPtr) // NB : NEG IDEM
{
...
void TranslateIR::translate_F_OVERFLOW_SHL(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_F_OVERFLOW_SHRD(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_F_OVERFLOW_ROL(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_F_OVERFLOW_ROR(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_F_AUXILIARY_ADD(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_F_AUXILIARY_NEG(const TaintPtr &tPtr)
{
	BEGIN_RELATION_DECLARATION;
...
void TranslateIR::translate_F_AUXILIARY_SUB(const TaintPtr &tPtr)
{
	ObjectSource src0 = tPtr->getSource(0);
	ObjectSource src1 = tPtr->getSource(1);
...
void TranslateIR::translate_F_AUXILIARY_INC(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_F_AUXILIARY_DEC(const TaintPtr &tPtr)
{
...
void TranslateIR::translate_F_AAA(const TaintPtr &tPtr)
{
	// condition de AAA : "IF (((AL and 0FH) > 9) or (AF=1)"
...
void TranslateIR::translate_F_CARRY_DAA_DAS(const TaintPtr &tPtr)
{
...
std::string TranslateIR::getConstraintPredicateHeader(ADDRINT insAddress, PREDICATE p) const
{
...
std::string TranslateIR::getPredicateTranslation(TaintManager_Thread *pTmgrTls,
...
std::string TranslateIR::getConstraintPredicateFooter(bool taken) const
{
...
std::string TranslateIR::getConstraintNullDivisorHeader(ADDRINT insAddress) const
{
	// définition de l'entête de la contrainte : insertion d'un commentaire
	// avec le n° de contrainte, l'instruction et son adresse 
	return (";\n; contrainte " + decstr(_iAssert) \
...
std::string TranslateIR::getNullDivisorTranslation(const TaintPtr &divisorPtr)
{
...
std::string TranslateIR::getConstraintNullDivisorFooter() const
{
...
std::string TranslateIR::getConstraintDivOverflowHeader(bool isSignedDivision, ADDRINT insAddress) const
{
	// définition de l'entête de la contrainte : insertion d'un commentaire
	// avec le n° de contrainte, l'instruction et son adresse 
...
std::string TranslateIR::getDivOverflowTranslation(bool isSignedDivision, const TaintPtr& quotientPtr)
{
...
std::string TranslateIR::getConstraintDivOverflowFooter() const
{
	// déclaration de l'assertion en fin de contrainte 
...
// déclaration de l'entête d'une nouvelle contrainte pour un diviseur nul
std::string TranslateIR::getConstraintLoopHeader(ADDRINT insAddress) const
{
	// définition de l'entête de la contrainte : insertion d'un commentaire
	// avec le n° de contrainte, l'instruction et son adresse 
	std::string result(";\n; contrainte " + decstr(_iAssert));
...
std::string TranslateIR::getLoopTranslation(const TaintPtr &regCounterPtr)
{
...
std::string TranslateIR::getLoopTranslation(PREDICATE pred,
...
// déclaration du 'final' d'une contrainte sur le résultat d'une division
std::string TranslateIR::getConstraintLoopFooter() const
{
	// déclaration de l'assertion en fin de contrainte 
...
std::string TranslateIR::getConstraintAddressHeader(ADDRINT insAddress) const
{
	// définition de l'entête de la contrainte : insertion d'un commentaire
	// avec le n° de contrainte, l'instruction et son adresse 
...
std::string TranslateIR::getConstraintAddressTranslation(const TaintPtr &addrPtr, ADDRINT addrValue)
{
...
// déclaration du 'final' d'une contrainte sur le résultat d'une division
std::string TranslateIR::getConstraintAddressFooter() const
{
	// déclaration de l'assertion en fin de contrainte 
